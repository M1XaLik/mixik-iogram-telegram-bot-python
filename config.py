...
COMMANDS_LIST = (
    ...
    "• <b>/list</b> - <i>вивести список днів народження для поточного чату</i> \n\n"
    "• <b>/delete</b> - <i>видалити день народження із бази даних\nПримітка:\nдля коректної роботи використовуйте команду <code>/delete [id]</code> - де параметр \"id\" є порядковим номером запису\n(усі записи чату можна переглянути за допомогою команди <code>/list</code>) </i>\n<b>Важливо:</b> Видалити нагадування може лише <b>користувач, який його створив</b>, або <b>адміністратор чату</b> (якщо це група).\n\n"
    "\n\n"
    f"😊 Будьте певні, що жоден день народження не залишиться непоміченим! Бот автоматично надсилає привітання щодня о <b>{BIRTHDAY_REMINDER_HOUR}:{BIRTHDAY_REMINDER_MINUTE}</b> \n\n"
)
